export function terms() {
    return(
      <>
      <p><strong>Mobile App Terms and Conditions</strong></p>
  ...
  <ul>
  <li>
  <p><strong>"Application"</strong> means the software program provided by the Company downloaded by You on any electronic device, named [___APP_NAME___]</p>
  </li>
  <li>
